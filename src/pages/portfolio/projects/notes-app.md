...
title: "Aplicación de Notas con React y Zustand"
pubDate: 2025-10-21
description: "Aplicación de notas moderna, responsiva y eficiente creada con React."
languages: ["react", "javascript", "zustand", "vite"]
image:
  url: "/images/projects/notes-app.webp"
  alt: "Captura de pantalla de la App de Tareas"
---

**Aplicación de Notas con React y Zustand** Esta es una aplicación de notas moderna, responsiva y eficiente creada con **React**.  
...
El propósito principal fue dominar la gestión de estado asíncrona y la persistencia de datos en el navegador, patrones esenciales para cualquier aplicación web moderna de gran escala.
